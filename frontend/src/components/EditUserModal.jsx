    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="w-full max-w-lg rounded-lg bg-white p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            <label htmlFor="edit-user-name" className="block text-gray-700">
              Full Name
            </label>
            <Controller
              name="name"
              ...
              render={({ field }) => (
                <input {...field} id="edit-user-name" className="w-full rounded border p-2" />
              )}
            />
            {errors.name && <p className="mt-1 text-sm text-red-500">{errors.name.message}</p>}
          </div>
          <div className="mb-4">
            <label htmlFor="edit-user-email" className="block text-gray-700">
              Email
            </label>
            <Controller
              name="email"
              ...
              render={({ field }) => (
                <input {...field} id="edit-user-email" className="w-full rounded border p-2" />
              )}
            />
